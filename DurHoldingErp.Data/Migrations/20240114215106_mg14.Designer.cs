            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Closet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("93526695-7f26-419d-b040-b2b9fed8d70f"),
                            BarcodeId = 2994,
                            ClosetAmount = "2000",
                            ClosetName = "Babel Rezervuarsız",
                            ClosetPrice = "6120",
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7541),
                            IsDeleted = false
                        },
                        new
                        {
                            Id = new Guid("aac90208-cc01-4979-be3b-a28301a7002c"),
                            BarcodeId = 4427,
                            ClosetAmount = "1500",
                            ClosetName = "Babel Rezervuar",
                            ClosetPrice = "6400",
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7608),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7815),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7821),
                            DepartmentName = "It",
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7825),
                            DepartmentName = "Ik",
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7833),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7903),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7908),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(7911),
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 24,
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(8717),
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.KitchenCeramic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("089dc9ff-9a82-4df9-9daf-ffc202b32900"),
                            BarcodeId = 2427,
                            CeramicAmount = "400",
                            CeramicName = "xx02",
                            CeramicPrice = "3200",
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(8883),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(9262),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 15, 0, 51, 6, 392, DateTimeKind.Local).AddTicks(9277),
                            Email = "ademserifd@gmail.com",
                            IsDeleted = false,
                            Name = "Kerem",
                            Password = "123456",
