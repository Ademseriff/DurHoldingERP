            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Closet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a85d5494-6e97-4645-b360-3190b54875b2"),
                            BarcodeId = 6335,
                            ClosetAmount = "2000",
                            ClosetName = "Babel Rezervuarsız",
                            ClosetPrice = "6120",
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(1980),
                            IsDeleted = false
                        },
                        new
                        {
                            Id = new Guid("7f72a223-0530-4f5c-b537-17ee6cb62f3b"),
                            BarcodeId = 2619,
                            ClosetAmount = "1500",
                            ClosetName = "Babel Rezervuar",
                            ClosetPrice = "6400",
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(2122),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3147),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3161),
                            DepartmentName = "It",
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3171),
                            DepartmentName = "Ik",
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3180),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3190),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3200),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(3210),
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 24,
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(5953),
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.KitchenCeramic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8db1d1b7-a44e-40f1-b480-1934b76648ee"),
                            BarcodeId = 9289,
                            CeramicAmount = "400",
                            CeramicName = "xx02",
                            CeramicPrice = "3200",
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(6501),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("DurHoldingErp.Entity.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(7594),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 1, 16, 2, 30, 0, 881, DateTimeKind.Local).AddTicks(7624),
                            Email = "ademserifd@gmail.com",
                            IsDeleted = false,
                            Name = "Kerem",
                            Password = "123456",
